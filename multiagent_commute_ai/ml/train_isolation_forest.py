...
def validate_on_anomalies(model: IsolationForest, df: pd.DataFrame) -> None:
    """
    Report how many of the last 25 rows (known anomalies) were correctly flagged.
    The last 25 rows in commute_records.csv are the generated anomalous records.
    """
    print("\n[Validate] Checking last 25 rows (known anomalies)…")
...
if __name__ == "__main__":
    ...
    if not DATA_PATH.exists():
        print("[Setup] commute_records.csv not found. Generating…")
        import subprocess
